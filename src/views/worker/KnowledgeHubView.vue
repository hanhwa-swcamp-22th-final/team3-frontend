<script setup>
import { ref } from 'vue'
import WorkerKnowledgeHubContentHeader from '@/components/worker/kms/WorkerKnowledgeHubContentHeader.vue'
import WorkerKnowledgeHubFeed from '@/components/worker/kms/WorkerKnowledgeHubFeed.vue'
import WorkerKnowledgeHubMonthlyRank from '@/components/worker/kms/WorkerKnowledgeHubMonthlyRank.vue'
import WorkerKnowledgeHubMentoringMatchingStatus from '@/components/worker/kms/WorkerKnowledgeHubMentoringMatchingStatus.vue'

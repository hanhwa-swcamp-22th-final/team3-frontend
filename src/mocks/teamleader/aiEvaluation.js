...
export const aiEvaluationSelectedTarget = {
  voiceLabel: '음성 인식 및 텍스트 변환',
  voiceDescription: '메모형 음성 또는 메모를 텍스트 초안으로 변환하여 상단 입력 영역에 반영합니다.',
  convertedText:
    '[음성 인식 텍스트 변환 결과] 김신우 사원은 3월 2주차 설비 이상 상황에서도 우선 문제를 빠르게 식별했습니다. 이후 설비 담당자와 협업하여 18분 내 복구 작업을 완료했고, 이후 재발 방지 체크리스트를 정리했습니다. 다만 구두 보고 시 핵심 메시지 전달이 다소 분산된 경향이 있어 아래 수정 코멘트 영역에서 최종 문장으로 보완할 필요가 있습니다.',
}
